	 ...
	 private void initUI() {
	  ...
	  //      fileMenu.add(saveMenu);
		...
		case 3:
			...
			ja.append("\n" + "the Fitness of the solution is " + SimulatedAnnealing.Fitness(gui.solution));
			ja.append("\n" + "the Energy of the solution is " + SimulatedAnnealing.Energy(gui.solution));
		...
		case 4:
			...
			SimulatedAnnealing.changeRandom(gui.solution);
			ja.append("\n" + "the Energy of the solution is " + SimulatedAnnealing.Energy(gui.solution));
		...
		case 5:
			...
			HillClimbing.climbing(gui.solution);
			ja.append("\n" + "the Energy of the solution is " + SimulatedAnnealing.Energy(gui.solution));
			menuDisplay();
             break; }
